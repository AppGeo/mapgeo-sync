...
const handle_file_urls_1 = require("./handle-file-urls");
const emberAppDir = path.resolve(__dirname, '..', 'ember-dist');
const emberAppURL = url_1.pathToFileURL(path.join(emberAppDir, 'index.html')).toString();
let mainWindow = null;
...
electron_1.app.on('ready', async () => {
    ...
    //   }
    // }
    await handle_file_urls_1.default(emberAppDir);
